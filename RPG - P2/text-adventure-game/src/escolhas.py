...
def escolhas_1():
    ...
    print("\nKael: O que aconteceu comigo? Me sinto estranho...")
    ...
    if escolha == "1":
        ...
        print('"KAEL, VOCÊ É A ESPERANÇA DO NOSSO POVO. NÃO SEJA SEDUZIDO PELAS SOMBRAS."')
    elif escolha == "3":
        item_escolhido = "nada"
...
def cena_2():
    ...
    if item_escolhido == "chicote":
        ...
        print("Kael: Uau... como eu soube fazer isso?")
        ...
        print("Kael: Esse artefato... ele me protegeu!")
        ...
        print("Kael: Maldição! Eu devia ter pegado alguma coisa...")
