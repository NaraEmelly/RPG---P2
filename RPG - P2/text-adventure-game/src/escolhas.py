...
88888888888888888888888888888888888888888888888888888888888888888888888
    ...
    print("2. Voltar para o corredor e tentar encontrar uma pista no templo.")
    
    
    escolha = input("\n>> ").strip()
    
    if escolha == "1":
        print("\nVocê abre a porta e se assusta com a quantidade de morcegos que sai de dentro dessa sala." 
        "É apenas um lugar em ruínas com várias.")
        print(r"""                                                                                                                                             
